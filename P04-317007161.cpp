...
int main()
{
	...
	*/
	...
	glm::mat4 modelaux2(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía de la base
	glm::mat4 modelaux3(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía de las llantas
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::translate(model, glm::vec3(1.5f, 5.5f, -4.0));
		modelaux = model;

		model = glm::scale(model, glm::vec3(6.0f, 3.0f, 2.0f));
		...
		//ARTICULACION de llanta izquierda delantera 
		model = glm::translate(model, glm::vec3(-3.0f, -1.5f, 2.5f));
		//rotación alrededor de la articulación que une con la base
		...
		//LLANTA izquierda delatenra 
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.7f, 2.3f, 1.7f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[2]->RenderMeshGeometry(); //dibuja cilindro
		//SE REINICIA la matriz desde la traslacion de la base (piramide cuadrangular)
		model = modelaux2;

		//ARTICULACION llanta derecha delatenra 
		model = glm::translate(model, glm::vec3(-3.0f, -1.5f, -2.5f));
		//rotación alrededor de la articulación que une con la base
		...
		//ARTICULACION llanta izquierda trasera 
		model = glm::translate(model, glm::vec3(3.0f, -1.5f, 2.5f));
		//rotación alrededor de la articulación que une con la base
		...
		//ARTICULACION llanta derecha traasera 
		model = glm::translate(model, glm::vec3(3.0f, -1.5f, -2.5f));
		//rotación alrededor de la articulación que une con la base
		...
		//**PARA REINICIAR LA MATRIZ DESDE LA CABINA
		model = modelaux;
		...
		model = modelaux;
		//tercer  brazo
		model = glm::translate(model, glm::vec3(1.75f, -0.85f, 0.0f));
		...
		*/
        ...
        //Creacion del perrito 
//matriz de modelo con valor de la matriz identidad
model = glm::mat4(1.0);

//CUERPO DEL PERRITO
model = glm::translate(model, glm::vec3(0.0f, 3.5f, -4.0));
modelaux = model;
...
//ARTICULACION pata izquierda delantera 
...
model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.7f));
model = glm::rotate(model, glm::radians(-135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
...
//rotación alrededor de la articulación que une al cuerpo
model = glm::rotate(model, glm::radians(mainWindow.getarticulacion9()), glm::vec3(1.0f, 0.0f, .0f));
modelaux2 = model;
